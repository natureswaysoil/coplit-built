      ...
      <div className="mt-6 pt-6 border-t">
        <div className="space-y-2">
          {[5, 4, 3, 2, 1].map((stars) => {
            ...
            return (
              <div key={stars} className="grid grid-cols-[auto,1fr,auto] items-center gap-3 text-sm text-gray-600">
                <span>{stars} out of 5</span>
                <div className="w-full border border-gray-200 rounded-full h-2">
