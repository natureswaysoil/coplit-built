    ...
    <footer style={{
      ...
      <div className="container">
        <div style={{
          ...
          {/* Quick Links */}
          <div>
            <h4 style={{color: '#1f2937', marginBottom: 'var(--space-md)'}}>Quick Links</h4>
          ...
          {/* Customer Service */}
          <div>
            <h4 style={{color: '#1f2937', marginBottom: 'var(--space-md)'}}>Customer Service</h4>
            <ul style={{listStyle: 'none', padding: 0}}>
              <li style={{marginBottom: 'var(--space-sm)'}}>
              ...
              <li style={{marginBottom: 'var(--space-sm)'}}>
                <Link href="/refund-policy" style={{color: '#6b7280', textDecoration: 'none'}}>Refund Policy</Link>
              </li>
              <li style={{marginBottom: 'var(--space-sm)'}}>
                <Link href="/cart" style={{color: '#6b7280', textDecoration: 'none'}}>Shopping Cart</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Contact Info */}
          <div>
            <h4 style={{color: '#1f2937', marginBottom: 'var(--space-md)'}}>Get In Touch</h4>
            <p style={{fontSize: '0.9rem', color: '#6b7280', marginBottom: 'var(--space-sm)'}}>
