...
export function ShopCartProvider({ children }: PropsWithChildren<{}>): JSX.Element {
...
export function useCart(): CartContextValue {
  ...
  if (!ctx) throw new Error("useCart must be used within <ShopCartProvider>");
  return ctx;
}
