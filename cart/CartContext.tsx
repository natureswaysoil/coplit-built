...
export const CartProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const updateQty = (sku: string, qty: number) => setItems(prev => {
    const copy = [...prev];
    ...
    // cart/CartContext.tsx
// If you use the App Router, you can add: "use client";
import React, {
  createContext,
  useContext,
  useMemo,
...
// use undefined instead of null to improve type safety in the hook
