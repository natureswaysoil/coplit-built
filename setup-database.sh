...
echo ""
echo "🗄️  Database Tables to Create:"
...
echo "   👉 https://supabase.com/dashboard/project/gixjfavlefeldoostsij"
echo ""
echo "2. Go to the SQL Editor tab"
echo ""
echo "3. Copy and paste the SQL from this file:"
echo "   👉 $(pwd)/supabase/migrations/001_orders_add_tax_shipping.sql"
echo ""
